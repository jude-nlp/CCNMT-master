...
PARA_SRC_TRAIN_RAW=$PREP/$SRC-$TGT/opus.$SRC-$TGT-train.$SRC
PARA_TGT_TRAIN_RAW=$PREP/$SRC-$TGT/opus.$SRC-$TGT-train.$TGT
PARA_SRC_VALID_RAW=$PREP/$SRC-$TGT/opus.$SRC-$TGT-dev.$SRC
PARA_TGT_VALID_RAW=$PREP/$SRC-$TGT/opus.$SRC-$TGT-dev.$TGT
PARA_SRC_TEST_RAW=$PREP/$SRC-$TGT/opus.$SRC-$TGT-test.$SRC
PARA_TGT_TEST_RAW=$PREP/$SRC-$TGT/opus.$SRC-$TGT-test.$TGT
